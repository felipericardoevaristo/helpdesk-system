...
public class ResourceExceptionalHandler {
    ...
    @ExceptionHandler(ObjectNotFoundException.class)  /*manipulador de exceções da classe ObjectNotFoundException*/
    ...
    public ResponseEntity<StandardError> validationErrorsConstraint(ConstraintViolationException ex,
                                                          HttpServletRequest request){
